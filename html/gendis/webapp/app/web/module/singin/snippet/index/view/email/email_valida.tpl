...
>
    <div style="margin-right: 40px; margin-left: 40px; margin-top: 10px;">
        ...
        <h2 style="margin: 0px;">Se ha verificado su Correo electr&oacute;nico</h2>
        <br>
        Ya puede ingresar al sistema de informaci&oacute;n MNHN-SIB
        <br><br>
        Haz click en el siguiente boton.
        <br><br>
        <a href="{$url_dominio}/login" style="-webkit-text-size-adjust: none; text-decoration: none; display: inline-block;
...
1px solid #53ba3e; border-bottom: 1px solid #53ba3e; border-left: 1px solid #53ba3e; padding-top:
 ...
 mso-line-height-alt: 32px;"><strong>Entrar a SIB de MNHN</strong></span></span></a>
