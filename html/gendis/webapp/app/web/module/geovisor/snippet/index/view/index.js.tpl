    ...
    var snippet_geovisor = function () {
        ...
        var getGroupedOverlays = function(){
            ...
            layer_departamento = L.tileLayer.wms(geoserver_mmaya+'?', {
                layers: workspaces+'departamento',
                format: 'image/png',
                uppercase: true,
                transparent: true,
            ...
            cuencas_operativas = L.tileLayer.wms(geoserver_mmaya+'?', {
                layers: workspaces+'51_cuencas_operativas',
                format: 'image/png',
                uppercase: true,
                transparent: true,
                continuousWorld : true,
            ...
            var ecorregiones_ibish = L.tileLayer.wms(geoserver_mmaya+'?', {
                layers: workspaces+'ecorregiones_ibish',
                format: 'image/png',
                uppercase: true,
                transparent: true,
                continuousWorld : true,
...
//                legendImagePath: 'https://simb.siarh.gob.bo/simb/resources/leaflet/openweathermap/files/NT2.png',
            ...
            var hidro_rios_principales = L.tileLayer.wms(geoserver_mmaya+'?', {
                layers: workspaces+'rios_principales',
                format: 'image/png',
                uppercase: true,
                transparent: true,
                continuousWorld : true,
            ...
            var hidro_rios_secundarios = L.tileLayer.wms(geoserver_mmaya+'?', {
                layers: workspaces+'rios_secundarios',
                format: 'image/png',
                uppercase: true,
                transparent: true,
                continuousWorld : true,
            ...
            var mnhn_geologia = L.tileLayer.wms(geoserver_mmaya+'?', {
                layers: workspaces+'geologia',
                format: 'image/png',
                transparent: true,
                opacity: 0.8
            });
            ...
            var mnhn_vegetacion = L.tileLayer.wms(geoserver_mmaya+'?', {
                layers: workspaces+'vegetacion',
                format: 'image/png',
                transparent: true,
                opacity: 0.8
            });
            var mnhn_Apn = L.tileLayer.wms(geoserver_mmaya+'?', {
                layers: workspaces+'areas_prot_nal',
                format: 'image/png',
                transparent: true,
                opacity: 0.8
            });
            ...
            var mnhn_Apd = L.tileLayer.wms(geoserver_mmaya+'?', {
                layers: workspaces+'areas_prot_dep',
                format: 'image/png',
                transparent: true,
                opacity: 0.8
            });
            var mnhn_sitiosramsar = L.tileLayer.wms(geoserver_mmaya+'?', {
                layers: workspaces+'sitios_ramsar',
                format: 'image/png',
                transparent: true,
                opacity: 0.8
            });
            var mnhn_biogeografia = L.tileLayer.wms(geoserver_mmaya+'?', {
                layers: workspaces+'biogeografia',
                format: 'image/png',
                transparent: true,
                opacity: 0.8
            });
            var mnhn_zonasvida = L.tileLayer.wms(geoserver_mmaya+'?', {
                layers: workspaces+'zonasvida',
                format: 'image/png',
                transparent: true,
                opacity: 0.8
            });
            var mnhn_reservasforestales = L.tileLayer.wms(geoserver_mmaya+'?', {
                layers: workspaces+'reservasforestales',
                format: 'image/png',
                transparent: true,
                opacity: 0.8
            });
            var mnhn_tcos = L.tileLayer.wms(geoserver_mmaya+'?', {
                layers: workspaces+'tcos',
                format: 'image/png',
                transparent: true,
                opacity: 0.8
            });
