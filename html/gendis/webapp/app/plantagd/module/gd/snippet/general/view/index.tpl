...
<div class="card card-custom gutter-b example example-compact">
    ...
    <form method="POST"
        ...
        <div class="card-body">
            ...
            <div class="col-lg-12">
                <label>{#field_distributor_id#} <span class="text-danger bold">*</span> : </label>
                <div class="input-group">
                    <select class="form-control m-select2 select2_general"
                            name="item[distribuidor_id]" id="type_select_distribuitor"
                            data-placeholder="{#field_Holder_distributor_id#}" {$privFace.input}
                            required
                ...
                <span class="form-text text-black-50">{#field_GroupMsg_distributor_id#}</span>
            </div>
            </div>
        </div>
