            ...
            table_list = table_list_var.DataTable({
                ...
                columnDefs: [
                    ...
                    },
                    {
                        ...
                        render: function(data, type, full, meta) {
                            var status = {
                                'Nanogeneración': {'title': 'Nanogeneración', 'class': ' label-light-warning'},
                                'Microgeneración': {'title': 'Microgeneración', 'class': ' label-light-primary'},
                                'Minigeneración': {'title': 'Minigeneración', 'class': ' label-light-info'},
                            };
