<?PHP
namespace App\Plantagd\Geolinera\Index;
use Core\CoreResources;

class Index extends CoreResources {
    var $objTable = "electrolinera";
    ...
    function getPoint($filter){
        ...
        //$this->dbm->debug = true;
        $sql = "select 
                p.* from ".$this->table["electrolinera"]." as p       
        ";
    ...
    function getSummary($item=""){
        ...
        $sql = "select 
                ...
                LEFT JOIN ".$this->table["electrolinera"]." as p on p.departamento_id=dep.id
                ";
