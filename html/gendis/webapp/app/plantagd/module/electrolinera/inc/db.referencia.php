...
$db_table = array();
$dbSchemaName = "public";
$db_table[] = Core::getTableConfig("electrolinera");
$db_table[] = Core::getTableConfig("electrolinera_tipo_cargador");
...
$db_table[] = Core::getTableConfig("gd_tipo_cargador");
$db_table[] = Core::getTableConfig("gd_estado_conector");
