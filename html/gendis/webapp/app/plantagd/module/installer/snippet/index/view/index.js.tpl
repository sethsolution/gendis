            ...
            table_list = table_list_var.DataTable({
                ...
                columnDefs: [
                    ...
                    },
                    {
                        ...
                        render: function(data, type, full, meta) {
                            var status = {
                                'Nacional': {'title': 'Nacional', 'class': ' label-light-primary'},
                                'Extranjera': {'title': 'Extranjero', 'class': ' label-light-danger'}
                            };
                    ...
                    },
                    {
                        ...
                        searchable: false,
                        render: function(data,type,full,meta){
                            return '<span style="color: #006be3;">' + new Intl.NumberFormat('en-US',{ minimumFractionDigits: 0 }).format(data) + ' </span>';
                        },
                    },
