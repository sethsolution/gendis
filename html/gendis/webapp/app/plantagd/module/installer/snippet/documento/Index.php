...
class Index extends CoreResources {
    var $objTable = "instalador_archivo";
    var $folder = "requisito";
    ...
    public function getItemDatatableRowsCategory($item_id,$id){
        switch ($id){
            case 1:
                $this->category_id = "";
                break;
        ...
        $this->getItemDatatableRows($item_id);
    }

    public function getItemDatatableRows($item_id,$category_id=0){
        global $dbSetting;
        ...
        if(trim($category_id)=="")$category_id = 0;
        $extraWhere .= " and categoria_id='".$category_id."' ";
        ...
        foreach ($result['data'] as $itemId => $valor) {
            $result['data'][$itemId]['fecha_entrega'] = $this->changeDataFormat($result['data'][$itemId]['fecha_entrega']);
    ...
    function deleteData($id,$item_id){
        ...
        $this->dbm->AutoExecute($this->objTable,$rec,"UPDATE",$where);
