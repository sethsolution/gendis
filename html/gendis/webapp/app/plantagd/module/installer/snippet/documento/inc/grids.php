...
$grid_item[]=array("field" => "fecha_entrega","label"=> $smarty->config_vars["table_fecha_entrega"]);

$grid_item[]=array("field"=> "attached_name","label"=> $smarty->config_vars["table_attachment_name"]);
