<?PHP
namespace App\Plantagd\Geoinstalador\Index;
...
class Index extends CoreResources {
    ...
    function getPoint($filter){
        ...
        //$this->dbm->debug = true;
        $sql = "select 
                p.* from ".$this->table["instalador"]." as p       
        ";
        ...
        $sql .= "  (location_longitude_decimal is not null and  location_latitude_decimal is not null)";
        //$sql .= " limit 5";
...
//        print_struc($sql);exit();
    ...
    function getSummary($item=""){
        ...
        $sql = "select 
                ...
                LEFT JOIN ".$this->table["instalador"]." as p on p.departamento_id=dep.id
                ";
