...
class Index extends CoreResources {
    ...
    function getPoint($filter){
        ...
        foreach ($dato as $row){
             ...
             * Datos personales
             */
            unset($row["nombre_consumidor"]);
            unset($row["ci"]);
            unset($row["direccion"]);
            unset($row["numero"]);
            unset($row["barrio_zona"]);
            unset($row["ciudad"]);
            unset($row["email"]);
            unset($row["telefono"]);
            unset($row["celular"]);
            unset($row["persona_juridica"]);
            unset($row["nit"]);

            unset($row["fuente_generacion_otro"]);
            unset($row["responsable_nombre"]);
            unset($row["responsable_telefono"]);
            unset($row["responsable_email"]);
            unset($row["lugar"]);
            unset($row["fecha"]);

            unset($row["instalador_id"]);
            unset($row["distribuidor_id"]);
            unset($row["departamento_id"]);
            unset($row["provincia_id"]);
            unset($row["municipio_id"]);
            unset($row["localidad_id"]);
            unset($row["localidad"]);
            unset($row["zona_id"]);
            unset($row["categoria"]);
