    ...
    var snippet_list = function() {
        ...
        var initTable = function() {
            ...
            table_list = table_list_var.DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: urlsys+'/list?{/literal}filter[departamento]={$filter.departamento}&filter[filtro_gd_categoria]={$filter.filtro_gd_categoria}&filter[filtro_gd_tipo_fuente_generacion]={$filter.filtro_gd_tipo_fuente_generacion}{literal}',
                    type: 'POST',
                    data: {},
                },
                columns: [
