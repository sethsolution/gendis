...
<script src="/js/geo/leaflet.markercluster/dist/leaflet.markercluster.js"></script>
...
<script>
    ...
    var snippet_geovisor = function () {
        ...
        var map_default_center = [-17.403918, -65.354500];
        ...
        var getGroupedOverlays = function(){
            ...
            cuencas_operativas = L.tileLayer.wms(geoserver_mmaya+'?', {
                layers: 'aetn:51_cuencas_operativas',
                format: 'image/png',
                uppercase: true,
                transparent: true,
                continuousWorld : true,
            ...
            var ecorregiones_ibish = L.tileLayer.wms(geoserver_mmaya+'?', {
                layers: 'aetn:ecorregiones_ibish',
                format: 'image/png',
                uppercase: true,
                transparent: true,
                continuousWorld : true,
...
//                legendImagePath: 'https://simb.siarh.gob.bo/simb/resources/leaflet/openweathermap/files/NT2.png',
        ...
        var createMap = function(){
            ...
            json_marker = L.markerClusterGroup({
            ...
            json_layer.on('data:loaded', function () {
                json_marker.addLayer(json_layer);
                map.addLayer(json_marker);
            });
            ...
            L.Control.Watermark=L.Control.extend({
                onAdd:function(map){
                    ...
                    img.src = '/images/logo/geovisor-logo.png';
        ...
        var popUp = function(f,l){
            ...
            if (f.properties){
                ...
                info += "<strong>Nombre Consumidor:</strong> <BR>"+ f.properties["nombre_consumidor"]+"<strong> C.I.:</strong>"+f.properties["ci"]+" ";

                out.push(info);

                out.push("<strong>Barrio o zona:</strong> "+ f.properties["barrio_zona"]);
                out.push("<strong>Celular:</strong> "+ f.properties["celular"]);
                out.push("<strong>Persona Jurídica:</strong> "+ f.properties["persona_juridica"]);
                ...
                boton ="";
                boton += "<a style='margin-bottom: 5px;' href=\"javascript:snippet_geovisor.editGd("+f.properties["id"]+")\"  class=\"btn btn-success btn-sm mr-3\"><span><i class=\"flaticon-edit\"></i><span>Editar GD</span></span></a> ";
