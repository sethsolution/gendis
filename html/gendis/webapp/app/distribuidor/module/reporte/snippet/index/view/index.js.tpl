                ...
                columnDefs: [
                    {
                        ...
                        render: function(data, type, full, meta) {
                            ...
                            if(full.estado_id == '1' || full.estado_id == '3'){
                                ...
                                boton += '<a href="javascript:snippet_list.update(\'' + data + '\');" class="btn btn-success btn-sm" title="' + lbEdit + '">' + "Ver dato" + '</a>';
                            }
                            boton += '<div>';
                            return boton;
                        },
                    ...
                    },
                    {
                        ...
                        render: function(data,type,full,meta){
                            if (data == null){ data = "";}
                            return '<span class="text-info font-size-xs">' + data+ '</span>';
                        },
                    },
