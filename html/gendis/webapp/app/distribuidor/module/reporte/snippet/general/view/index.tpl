    ...
    {elseif $item.estado_id == 2}
        <div class="card-body pt-0 pb-0 pl-5 pr-5">
            <div class="alert alert-custom fade show pt-1 pb-1 pl-5 pr-5 ayuda" role="alert">
                ...
                <div class="alert-text text-justify text-black" >{#message_send#}</div>
            </div>
        </div>
    {/if}
    ...
    <form method="POST"
        ...
        <div class="card-body">
            <div class="form-group row">
                ...
                {if $privFace.edit == 1}
                <div class="col-lg-12">
                    <label>{#field_background#} </label>
                    <div class="m-input-icon m-input-icon--right">
                        <div class="summernote" id="antecedentes">{$item.antecedentes}</div>
                        <input class="form-control m-input" type="hidden" name="item[antecedentes]"
                               id="antecedentes_input" {$privFace.input}>
                    </div>
                </div>
                <div class="col-lg-12">
                    <label>{#fiel_description#} </label>
                    <div class="m-input-icon m-input-icon--right">
                        <div class="summernote" id="descripcion">{$item.descripcion}</div>
                        <input class="form-control m-input" type="hidden" name="item[descripcion]"
                               id="descripcion_input" {$privFace.input}>
                    </div>
                </div>
                <div class="col-lg-12">
                    <label>{#fiel_observation#} </label>
                    <div class="m-input-icon m-input-icon--right">
                        <div class="summernote" id="observaciones">{$item.observaciones}</div>
                        <input class="form-control m-input" type="hidden" name="item[observaciones]"
                               id="observaciones_input" {$privFace.input}>
                    </div>
                </div>
                <div class="col-lg-12">
                    <label>{#fiel_conclusions#} </label>
                    <div class="m-input-icon m-input-icon--right">
                        <div class="summernote" id="conclusiones">{$item.conclusiones}</div>
                        <input class="form-control m-input" type="hidden" name="item[conclusiones]"
                               id="conclusiones_input" {$privFace.input}>
                    </div>
                </div>
                {else}
                    <div class="col-lg-12">
