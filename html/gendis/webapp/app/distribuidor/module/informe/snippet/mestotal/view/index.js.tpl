            ...
            table_list = table_list_var.DataTable({
                ...
                columnDefs: [
...

                    {
                        ...
                        className:"text-right",
                        render: function(data,type,full,meta){
                            return '<span style="color: #8a00da;">' + new Intl.NumberFormat('en-US',{ minimumFractionDigits: 2 }).format(data) + ' </span>';
                        },
                    },
                    {
                        targets: 2,
                        ...
                        render: function(data, type, full, meta) {
                            var status = {
                                '1': {'title': 'Nanogeneración', 'class': ' label-light-warning'},
                                '2': {'title': 'Microgeneración', 'class': ' label-light-primary'},
                                '3': {'title': 'Minigeneración', 'class': ' label-light-info'},
                            };
